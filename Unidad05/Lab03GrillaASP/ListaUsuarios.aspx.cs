    ...
    public partial class ListaUsuarios : System.Web.UI.Page
    {
        ...
        protected void grdUsuarios_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.ToLower() == "insertar")
            {
                TextBox cajaTexto;
                string textoActual;
                Lab03Negocio.Usuario usuarioNuevo = new Lab03Negocio.Usuario();
                ...
                Lab03Negocio.ManagerUsuarios manager = new Lab03Negocio.ManagerUsuarios();
