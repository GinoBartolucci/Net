...
namespace Lab03Negocio
{
    public class ManagerUsuarios
    {
        ...
        {
            const string ConnectionString = "Data Source = localhost/SQLEXPRESS; Initial Catalog = academia; Integrated Security = true; ";
            this.Conn = new SqlConnection(ConnectionString);
            //DESKTOP-IN1SDFG\SQLEXPRESS
        }
